               ...
               <Col s={6} offset='s3'>
                ...
                return(
                     <Col s={6} m={4} key={i.toString()}>
                        {i===0?
                        <input className='formL' label={"Commissioner"} id={(i).toString()} type="email" value={props.lEmails[0]} disabled={true}></input>:
                        <input className='formI' label={"Player Email # "+x.toString()} id={(i).toString()} type="email" onChange={props.handleEmailCh}></input>}
                    </Col>
                        )}
                ):<div></div>} 
                <Row>
